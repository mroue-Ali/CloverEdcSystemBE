...
namespace CloverEdc.Data.Migrations
{
    ...
    [Migration("20241119200918_ThrdDbStr")]
    partial class ThrdDbStr
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CloverEdc.Core.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("39685b04-9e96-4d77-bf22-b1b9135ba94c"),
                            DateCreated = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "admin@example.com",
                            IsDeleted = false,
                            Password = "AQAAAAIAAYagAAAAEL6Y309UTokX8rF+NOqQoVR9n+WDQExo85uMWxtkfTEQnEOOpS8ypnsbqjzq7KsJ2w==",
                            RefreshToken = new Guid("b0e77303-d8d2-4417-9d5c-9020cb7851f4"),
                            RoleId = new Guid("f45a7e79-845f-47df-af36-dc486e563772"),
                            UserName = "admin"
                        },
                        new
                        {
                            Id = new Guid("d6eff6b7-4368-4cb3-b502-e57b020471f1"),
                            DateCreated = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "superAdmin@example.com",
                            IsDeleted = false,
                            Password = "AQAAAAIAAYagAAAAEL6Y309UTokX8rF+NOqQoVR9n+WDQExo85uMWxtkfTEQnEOOpS8ypnsbqjzq7KsJ2w==",
                            RefreshToken = new Guid("95c8439e-7dd1-48d4-9a70-d1ec320e9663"),
