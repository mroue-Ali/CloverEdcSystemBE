...
namespace CloverEdc.Data.Migrations
{
    ...
    [Migration("20241126144158_fixUser")]
            ...
            modelBuilder.Entity("CloverEdc.Core.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cfd5dbde-af3a-4bf1-9c7d-764daff4f48d"),
                            DateCreated = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "admin@example.com",
                            FirstName = "A",
                            IsDeleted = false,
                            LastName = "Admin",
                            Password = "AQAAAAIAAYagAAAAEOuYv0NWFd1lauBmKIUZ6vKt++Vka3sBMtYDiwepZaYmdusR5D5zNV2UlWa3G8BSyg==",
                            RefreshToken = new Guid("f5be1d7d-bc87-4e13-84ad-c165c3554b38"),
                            RoleId = new Guid("f45a7e79-845f-47df-af36-dc486e563772"),
                            UserName = "admin"
                        },
                        new
                        {
                            Id = new Guid("5437ab99-4354-4524-b112-b3930e4dba92"),
                            DateCreated = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            LastName = "Admin",
                            Password = "AQAAAAIAAYagAAAAEOuYv0NWFd1lauBmKIUZ6vKt++Vka3sBMtYDiwepZaYmdusR5D5zNV2UlWa3G8BSyg==",
                            RefreshToken = new Guid("f6e2b7dd-ba5f-4124-8640-f56923b3d2fe"),
